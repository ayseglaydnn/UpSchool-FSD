...
namespace UpSchool.WebApi.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Add(AccountAddDto accountAddDto,CancellationToken cancellationtoken)
        {
            ...
            var accounDto = AccountDto.MapFromAccount(account);

            await _accountsHubContext.Clients.All.SendAsync(SignalRMethodHeys.Accounts.Added, accounDto,cancellationtoken);
